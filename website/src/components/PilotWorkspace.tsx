          ...
          <section key={step} className="pilot-workspace__panel">
            {step === "intake" && <>
              ...
              <div className="pilot-form">
                ...
                <label>Tipo de negocio<select defaultValue="abarrotes"><option value="abarrotes">Tienda de abarrotes</option><option value="taqueria">Taquería</option><option value="other">Otro pequeño negocio</option></select></label>
            ...
            {step === "decision" && <>
              ...
              <div className="pilot-score-grid"><div className="pilot-score-card pilot-score-card--hero"><span>Puntaje Olin</span><strong>68.4</strong><small>IC 57.1–75.6 · cobertura 60%</small></div><div className="pilot-score-card"><span>Ruta</span><strong>Nivel 7</strong><small>C2 · D2 · S2</small></div><div className="pilot-score-card"><span>Acción sugerida</span><strong>Comité</strong><small>Revisar identidad y evidencia bancaria faltante.</small></div></div>
              <div className="pilot-reasons"><strong>¿Por qué esta ruta?</strong><ul><li>La capacidad de pago parece adecuada, pero usa evidencia sintética.</li><li>No se adjuntó un consentimiento Círculo ni una INE verificados.</li><li>Un expediente en modo sombra nunca puede autorizar un desembolso.</li></ul></div>
            </>}
            {step === "outcome" && <>
