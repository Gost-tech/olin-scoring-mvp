...
colors:
  ...
  text-muted: "#10251E"
  text-light: "#9A9A9A"
  accent-light: "rgba(206, 255, 100, 0.08)"
  accent-medium: "rgba(206, 255, 100, 0.15)"
  border: "rgba(206, 255, 100, 0.2)"
  card-bg: "rgba(206, 255, 100, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  h4-eyebrow:{ fontFamily: "Inter", cqw: 0.8, weight: 610, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Inter", px: 12, weight: 400, color: "primary" }
  counter: { fontFamily: "Inter", px: 13, weight: 400, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Inter, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Inter", cqw: 1.25, weight: 400, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Inter", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Inter", cqw: 2.4, weight: 400, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Inter", cqw: 2.6, weight: 610, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
...
- **Weights** — the brand font ships `{400, 610, 640, 650, 700, 750, 760, 780, 800, 820, 830}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
