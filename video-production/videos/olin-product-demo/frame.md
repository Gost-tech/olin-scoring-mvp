...
description: >
  ...
  accent, the three-step gray text ladder, -apple-system (display/numerals/chrome) + -apple-system (body),
...
colors:
  ...
  text-muted: "#3FB950"
  text-light: "#9A9A9A"
  accent-light: "rgba(227, 179, 65, 0.08)"
  accent-medium: "rgba(227, 179, 65, 0.15)"
  border: "rgba(227, 179, 65, 0.2)"
  card-bg: "rgba(227, 179, 65, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (-apple-system body + -apple-system chrome) —
  body:    { fontFamily: "-apple-system", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "-apple-system", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "-apple-system", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "-apple-system", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (-apple-system, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "-apple-system", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "-apple-system", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "-apple-system", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "-apple-system", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "-apple-system", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "-apple-system", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "-apple-system", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **-apple-system** (display) / **Arial** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **-apple-system** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **-apple-system** (body, muted gray, line 1.6). Headlines are near-black;
...
- **-apple-system** (display/numerals/chrome) + **-apple-system** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (-apple-system body 0.85cqw muted; -apple-system eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (-apple-system `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body -apple-system 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line -apple-system `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + -apple-system label + muted desc + optional
...
blockquote, cite. **Focal** a -apple-system `blockquote` near-black under a 15%-opacity cobalt
...
-apple-system body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a -apple-system `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body -apple-system 400 muted, line 1.6.
...
- **Type** — -apple-system headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; -apple-system body muted line 1.6; ≥1.4cqw floor.
...
- **-apple-system + -apple-system via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
